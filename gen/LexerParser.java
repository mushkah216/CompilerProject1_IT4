...
public class LexerParser extends Parser {
	...
	public static class StartContext extends ParserRuleContext {
		...
		public TerminalNode WS() { return getToken(LexerParser.WS, 0); }
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof LexerListener ) ((LexerListener)listener).enterStart(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof LexerListener ) ((LexerListener)listener).exitStart(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof LexerVisitor ) return ((LexerVisitor<? extends T>)visitor).visitStart(this);
